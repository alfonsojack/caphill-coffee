  ...
  it("should display a detailed selected shop page", () => {
    ...
    cy.wait("@shops").then((interception) => {
      ...
      cy.get(".header")
        ...
        .get(".shop-info-left-container > :nth-child(4)")
        .contains("p", "Dine In: ✅")
        .get(".shop-info-left-container > :nth-child(5)")
        .contains("p", "Take Out: ✅")
        .get(".shop-info-left-container > :nth-child(6)")
        .contains("p", "Wheelchair Accessible: ✅")
        .get(".shop-info-left-container > :nth-child(7)")
        .contains("p", "Food Provided: ✅")
        .get(".shop-info-left-container > :nth-child(8)")
